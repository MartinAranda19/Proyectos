...
INSTRUCCIONES: Para compilar y ejecutar el código se utilizó el makefile creado, por favor para compilar escriba, dentro de la carpeta 'CityDefender', en la terminal WSL correspondiente la palabra make y para ejecutar el código escriba en la terminal correspondiente la palabra make run.
